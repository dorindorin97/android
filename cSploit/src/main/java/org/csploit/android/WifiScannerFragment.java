...
public class WifiScannerFragment extends ListFragment
{
    ...
    public void onFailedConnection(){
        ...
        mStatusText.setText(HtmlCompat.fromHtml(getString(R.string.connection_to) + mCurrentAp.SSID + getString(R.string.connection_to2), HtmlCompat.FROM_HTML_MODE_LEGACY));
    ...
    private int performConnection(final ScanResult ap, final String key){
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (key != null)
                    mStatusText.setText(HtmlCompat.fromHtml(getString(R.string.wifi_attempting_to) + " <b>" + ap.SSID + "</b> " + getString(R.string.wifi_with_key) + " <b>" + key + "</b> ...", HtmlCompat.FROM_HTML_MODE_LEGACY));
                else
                    mStatusText.setText(HtmlCompat.fromHtml(getString(R.string.wifi_connecting_to) + " <b>" + ap.SSID + "</b> ...", HtmlCompat.FROM_HTML_MODE_LEGACY));
            }
        });
