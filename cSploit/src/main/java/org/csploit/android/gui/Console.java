        ...
        public void onEnd(int exitCode) {
            ...
            try {
                ...
                Console.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mOutput.append(HtmlCompat.fromHtml("\n<font color=\"green\">Enter Command:&gt;</font>  ", HtmlCompat.FROM_HTML_MODE_LEGACY));
       ...
       // mOutput.setMovementMethod(ScrollingMovementMethod.getInstance());
        ...
        runButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mOutput.append(HtmlCompat.fromHtml("<font color=\"red\">" + mInput.getText(, HtmlCompat.FROM_HTML_MODE_LEGACY).toString() + "</font>\n"));
